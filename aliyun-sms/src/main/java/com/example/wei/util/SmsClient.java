...
import com.example.wei.exception.SmsException;
import com.example.wei.template.BatchSmsTemplate;
...
import static com.example.wei.util.Utils.*;
...
public class SmsClient {
     ...
     */
    public void send(final String smsTemplateKey,final Map<String,String> templateParam, final String... phoneNumbers) {
        final SmsTemplate smsTemplate = this.smsTemplates.get(smsTemplateKey);
        Objects.requireNonNull(smsTemplate, () -> "SmsTemplate must be not null, key:" + smsTemplateKey);
